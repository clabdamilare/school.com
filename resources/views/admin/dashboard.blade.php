                ...
                <div class="timeline-event">
                  ...
                  <div class="d-flex align-items-center mb-1">
                    <div class="badge bg-lighter rounded-3">
                      ...
                      <img src="{{asset('backend/assets/img/icons/misc/pdf.png')}}" alt="img" width="15" class="me-2" />
                      ...
                      <div class="d-flex flex-wrap align-items-center">
                        <ul class="list-unstyled users-list d-flex align-items-center avatar-group m-0 me-2">
                          <li
                            ...
                            <img class="rounded-circle" src="{{asset('backend/assets/img/avatars/5.png')}}" alt="Avatar" />
                          </li>
                          <li
                            data-bs-toggle="tooltip"
                            data-popup="tooltip-custom"
                            ...
                            title="Allen Rieske"
                            class="avatar pull-up">
                            <img class="rounded-circle" src="{{asset('backend/assets/img/avatars/12.png')}}" alt="Avatar" />
                          </li>
                          <li
                            data-bs-toggle="tooltip"
                            data-popup="tooltip-custom"
                            ...
                            class="avatar pull-up">
                            <img class="rounded-circle" src="{{asset('backend/assets/img/avatars/6.png')}}" alt="Avatar" />
                          </li>
                          <li class="avatar">
                            <span
